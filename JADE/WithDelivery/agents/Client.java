...
public class Client extends Agent {
    ...
    private class RequestRestaurant extends Behaviour {  
        ...
        RequestRestaurant(int Order, String foodName){
            this.OrderId = Order;
            wantToEat = foodName;
        }
        ...
        public void action() {   
            ...
            case ANSWER:                
                ...
                order.setContent("I would like to order a " + wantToEat+"." + X + "." + Y);
